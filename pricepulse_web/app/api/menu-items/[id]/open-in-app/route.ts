...
/**
 * @swagger
 * /api/menu-items/{id}/open-in-app:
 *   get:
 *     summary: Get deep link to open menu item in platform app
 *     description: Generate deep link to open specific menu item in delivery platform app
 *     security:
 *       - ClerkAuth: []
 *     parameters:
 *       - name: id
